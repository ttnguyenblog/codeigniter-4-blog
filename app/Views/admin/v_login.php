                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="<?php echo site_url('admin/login') ?>">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <a class="small" href="<?php echo site_url("admin/forgot-password") ?>">Forgot Password?</a>
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small">
                                        <a href="<?php echo site_url("admin/register") ?>">Need an account? Sign up!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy;Blog Codeigniter 4</div>
                    </div>
                </div>
            </footer>
        </div>
