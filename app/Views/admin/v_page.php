...
<div class="card-body">
    <div class="row mb-3">
        ...
        <div class="col-lg-9 pt-1 pb-1 text-end">
            <a href="<?php echo site_url("admin/page/add") ?>" class="btn btn-xl btn-primary">+ Add New</a>
        </div>
    </div>
    <?php
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            foreach ($record as $value) {
                ...
                $link_edit = site_url("admin/page/edit/$post_id");
                $link_delete = site_url("admin/page/?action=delete&post_id=$post_id");
            ?>
                <tr>
