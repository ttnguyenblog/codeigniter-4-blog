...
<div class="card-body">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            <div class="col-lg-3">
                <input type='checkbox' name="set_front_page" value="1" <?php echo (isset($set_front_page)) ? 'checked' : '' ?> /> Front Page?
            </div>
            <div class="col-lg-3">
                <input type='checkbox' name="set_contact_page" value="1" <?php echo (isset($set_contact_page)) ? 'checked' : '' ?> /> Contact Page?
            </div>
        </div>
