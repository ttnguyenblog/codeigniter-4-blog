    ...
    <header>
        <nav>
            ...
            <div class="navigation-bar">
                <ul>
                    <li class="active"><a href="<?php echo site_url() ?>">Home<span class="underline"></span></a></li>
                    <li><a href="<?php echo site_url('blog') ?>">Blog<span class="underline"></span></a></li>
                    <li><a href="<?php echo set_post_link('55') ?>">About<span class="underline"></span></a></li>
                    <li><a href="<?php echo site_url('contact') ?>">Contact<span class="underline"></span></a></li>
                </ul>
            </div>
        </nav>
